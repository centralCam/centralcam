...
const Banner = () => {
  return (
    <section id='home' className="relative w-full min-h-96 bg-cover bg-right flex items-center justify-center mt-[-65px] md:bg-[url('/bg/bg-banner.webp')] bg-[url('/bg/bg-sm-banner.webp')]">
