      ...
      <article className="bg-primary-background">
        <div className="py-8 px-8 mx-auto max-w-screen-xl  sm:py-16 lg:px-6">
          <div className="max-w-screen-xl">
            ...
            <Link href={'/nosotros'} title="Ver más sobre nosotros" aria-label="Ver más sobre nosotros">
              <button className="text-white font-medium rounded-lg text-sm px-3 py-1.5 text-center bg-boton-primary hover:bg-boton-primary-hover active:bg-boton-primary-active" target='_blank'>Ver mas</button>
            </Link>
