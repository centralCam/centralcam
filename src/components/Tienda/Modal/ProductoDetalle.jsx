        ...
        <div className="max-w-screen-xl px-2 mx-auto 2xl:px-0">
            <div className="lg:grid lg:grid-cols-2 lg:gap-6 xl:gap-12">
                ...
                <div className="flex justify-center relative">
                    ...
                    <div className="absolute top-1 left-1 text-sm md:text-base bg-gradient-to-r from-primary to-secondary text-white font-bold px-3 py-1 rounded-tr-lg rounded-bl-lg shadow-md shadow-primary hover:scale-105 hover:cursor-pointer">
                    ...
                    <button onClick={handleShare} className="inline-flex items-center justify-center w-10 h-10 bg-primary hover:bg-green-600 rounded-full text-white z-10" >
                        <RiShareFill />
                    </button>
                </div>
