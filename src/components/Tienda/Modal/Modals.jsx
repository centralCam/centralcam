...
import DemoComponent from '../../Destacados/Destacados';
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 overflow-hidden">
      <div className="bg-white p-2 md:p-6 rounded-none lg:rounded-lg max-w-4xl w-full max-h-full overflow-y-auto">
        ...
        <section className=" py-0 bg-white md:py-16 antialiased">
            ...
            <div id='imagenes' className="shrink-0 max-w-md lg:max-w-lg mx-auto flex flex-col justify-center">
              ...
              <div className="flex flex-col mt-2 md:mt-6 lg:mt-0">
                ...
                <div className="mt-1 md:mt-4 gap-2 items-center flex flex-col md:flex-row justify-center md:items-start">
                  <button onClick={(e) => handleAddToCart(e, selectedProduct)} title="Agregar al carrito" className="text-gray-500 mt-2 md:mt-4 py-2 border-2 border-gray-200  hover:bg-boton-secondary-hover font-medium rounded-lg text-sm px-10 flex items-center justify-center" role="button" aria-label='agregar al carrito'>
                  ...
                  <Link href={enviar} title="consultar" className="text-gray-500 mt-2 md:mt-4 py-2 border-2 border-gray-200 hover:bg-boton-secondary-hover active:bg-boton-secondary-active font-medium rounded-lg text-sm px-10  flex items-center justify-center" role="button" target="_blank">
                    CONSULTAR
                  </Link>
                </div>
              </div>
          ...
          <h2 className="text-xl font-semibold text-gray-600 sm:text-2xl mt-8">Productos destacados que encontras en nuestra tienda</h2>
        <DemoComponent />
        </section>
      </div>
    </div>
