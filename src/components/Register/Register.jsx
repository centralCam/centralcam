...
export default function Register() {
  ...
  <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <Link href="#" className="flex items-center mb-6 text-2xl font-semibold text-gray-900" title="CentralCam Logo">
          <img className="w-8 h-8 mr-2" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/logo.svg" alt="logo" loading='lazy' title="CentralCam Logo" aria-label="CentralCam Logo"/>
          CentralCam    
      </Link>
